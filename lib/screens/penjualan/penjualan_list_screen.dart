...
import 'penjualan_create_screen.dart';
...
class _PenjualanListScreenState extends State<PenjualanListScreen> {
  ...
  void _loadData({bool refresh = false}) {
    ...
    Provider.of<PenjualanProvider>(context, listen: false).fetchPenjualan(
          ...
          ? FloatingActionButton(
              onPressed: () async {
                final result = await Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const PenjualanCreateScreen()));
        ...
        children: [
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Cari nomor atau pelanggan...',
                hintStyle: TextStyle(
          ...
          Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [null, 'Pending', 'Approved', 'Lunas', 'Canceled']
                    .map((status) {
          ...
          Consumer<PenjualanProvider>(
            builder: (ctx, provider, _) {
              ...
              final lunas = items.where((e) => e.status == 'Lunas').length;
                      ...
                      return GlassContainer(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  PenjualanDetailScreen(id: item.id),
                            ),
                          );
                        },
                        child: Padding(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            Formatters.date(item.tglTransaksi),
                                            style: TextStyle(
                                              fontSize: 11,
  ...
  Widget _buildLoadMoreButton(PenjualanProvider provider) {
    return Padding(
