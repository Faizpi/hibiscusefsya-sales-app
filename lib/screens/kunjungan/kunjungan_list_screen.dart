...
class KunjunganListScreen extends StatefulWidget {
  ...
  @override
  State<KunjunganListScreen> createState() => _KunjunganListScreenState();
}

class _KunjunganListScreenState extends State<KunjunganListScreen> {
  ...
  void _loadData() {
    ...
    Provider.of<KunjunganProvider>(context, listen: false).fetchKunjungan(
          ...
          ? FloatingActionButton(
              onPressed: () async {
                final result = await Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const KunjunganCreateScreen()));
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Cari nomor, tujuan, atau kontak...',
                hintStyle: TextStyle(
                        ...
                        child: InkWell(
                          onTap: () async {
                            await Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (_) =>
                                        KunjunganDetailScreen(id: item.id)));
                            _loadData();
                          },
                          borderRadius: BorderRadius.circular(14),
                          child: Padding(
  ...
  void _loadMore(KunjunganProvider provider) {
    setState(() => _displayCount += _pageSize);
